...
## Project Structure
    ...
    ├── fragrant_breeze_dev_90697  # Django project configurations
...
1. Clone this repo and `cd fragrant_breeze_dev_90697`
...
2. Clone this repo and `cd fragrant_breeze_dev_90697`
